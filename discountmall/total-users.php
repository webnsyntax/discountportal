    ...
    <div class="sidebar">
		...
		<li class="has_sub"><a href="#" class="open"><i class="fa fa-list-alt"></i> <span>Users</span> <span class="pull-right"><i class="fa fa-chevron-left"></i></span></a>
            <ul>
				...
				<li><a href="total-users.php" class="active">Total Users</a></li>
        ...
        <div class="container">
          ...
          <!-- Today status. jQuery Sparkline plugin used. -->
			...
			<div class="row">
                ...
                <div class="widget-head">
                  <div class="pull-left">Total Users List</div>
                  ...
                  <div class="widget-content">
                      ...
                      <tbody>
						...
						{	
							...
							while($user_details=mysql_fetch_array($users_list))
							{
								...
								echo "<td>
								<a href='user-fulldetails.php?Id=$user_details[1]' title='click to view'><button class='btn btn-xs btn-success'><i class='fa fa-check'></i></button></a>&nbsp;&nbsp;
								<a href='edit-userdetails.php?Id=$user_details[1]' title='click to edit'><button class='btn btn-xs btn-warning'><i class='fa fa-pencil'></i></button></a>";
								echo "</td>
								</tr>";
							}
						}
                    ...
                    <div class="widget-foot">
						...
						for($j=1; $j<=$total_pages; $j++)
							...
							if($j != $page)
							{
							echo "<li><a href='total-users.php?page=".$j."'> ".$j."</a></li>";
							}
							else
							{
							echo "<li class='active'><a href='total-users.php?page=".$j."'> ".$j."</a></li>";
							}
							}
						?>
                        </ul>
