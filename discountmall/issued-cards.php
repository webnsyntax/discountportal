...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <li><a href="issued-cards.php" class="active">Issued Cards</a></li>
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
        ...
        <div class="bread-crumb">
          ...
          <a href="#" class="bread-current">Pending Users List</a>
        </div>
        ...
        <div class="container">
          ...
          <!-- Today status. jQuery Sparkline plugin used. -->
			...
			<div class="row">
                ...
                <div class="widget-head">
                  <?php
                      $today_users=mysql_query("select * from users where dcard='1' and apply_status='yes'");
                      $urows=mysql_num_rows($today_users);
                  ?>
                  <div class="pull-left">Issued Cards List : <?php echo $urows; ?></div>
              ...
              <th>Issued On</th>
                      ...
                      <tbody>
						...
						{	
							$users_list=mysql_query("select * from users where dcard='1' and apply_status='yes' order by sno desc limit $start_from, 10");
							while($user_details=mysql_fetch_array($users_list))
							{
                $card_status=mysql_query("select posted_date, cardid from discards where userid='{$user_details[1]}'");
                $card_data=mysql_fetch_array($card_status);

								echo "<tr>
								<td>$user_details[2]</td>
                <td>$card_data[1]</td>
								<td>$user_details[12]</td>
								<td>$user_details[16]</td>
                <td>$card_data[0]</td>
								<td>
								<a href='user-fulldetails.php?Id=$user_details[1]'><button class='btn btn-xs btn-success'><i class='fa fa-check'></i></button></a>&nbsp;&nbsp;";
								echo "</td>
								</tr>";
							}
						}
                    ...
                    <div class="widget-foot">
						...
						for($j=1; $j<=$total_pages; $j++)
							...
							if($j != $page)
							{
							echo "<li><a href='issued-cards.php?page=".$j."'> ".$j."</a></li>";
							}
							else
							{
							echo "<li class='active'><a href='issued-cards.php?page=".$j."'> ".$j."</a></li>";
							}
							}
						?>
                        </ul>
