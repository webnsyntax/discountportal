    ...
    <div class="sidebar">
		...
		<li class="has_sub"><a href="#" class="open"><i class="fa fa-list-alt"></i> <span>Users</span> <span class="pull-right"><i class="fa fa-chevron-left"></i></span></a>
            <ul>
				...
				<li><a href="card-pendings.php" class="active">Pending Cards</a></li>
        ...
        <div class="container">
          ...
          <!-- Today status. jQuery Sparkline plugin used. -->
			...
			<div class="row">
                ...
                <div class="widget-head">
                  <?php
                      $today_users=mysql_query("select * from users where dcard='0' and apply_status='yes'");
                      $urows=mysql_num_rows($today_users);
                  ?>
                  <div class="pull-left">Pending Cards List : <?php echo $urows; ?></div>
                  ...
                  <div class="widget-content">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
						...
						{	
							$users_list=mysql_query("select * from users where dcard='0' and apply_status='yes' order by sno desc limit $start_from, 10");
							while($user_details=mysql_fetch_array($users_list))
							{
                $user_card=mysql_query("select * from discards where userid='{$user_details[1]}'");
                $card_details=mysql_fetch_array($user_card);
								echo "<tr>
								<td>$user_details[2]</td>
								<td>$user_details[6]</td>
                <td>$card_details[8]</td>
                    ...
                    <div class="widget-foot">
						...
						for($j=1; $j<=$total_pages; $j++)
							...
							if($j != $page)
							{
							echo "<li><a href='card-pendings.php?page=".$j."'> ".$j."</a></li>";
							}
							else
							{
							echo "<li class='active'><a href='card-pendings.php?page=".$j."'> ".$j."</a></li>";
							}
							}
						?>
                        </ul>
