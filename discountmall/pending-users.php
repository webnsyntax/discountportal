    ...
    <div class="sidebar">
		...
		<li class="has_sub"><a href="#" class="open"><i class="fa fa-list-alt"></i> <span>Users</span> <span class="pull-right"><i class="fa fa-chevron-left"></i></span></a>
            <ul>
				...
				<li><a href="pending-users.php" class="active">Pending Users</a></li>
        ...
        <div class="container">
          ...
          <!-- Today status. jQuery Sparkline plugin used. -->
			...
			<div class="row">
                ...
                <div class="widget-head">
                  <?php
                    $today_users=mysql_query("select * from users where apply_status='no'");
                    $urows=mysql_num_rows($today_users);
                  ?>
                  <div class="pull-left">Pending Users List : <?php echo $urows; ?></div>
                  ...
                  <div class="widget-content">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
						...
						{	
							$users_list=mysql_query("select * from users where apply_status='no' order by sno desc limit $start_from, 10");
                    ...
                    <div class="widget-foot">
						...
						for($j=1; $j<=$total_pages; $j++)
							...
							if($j != $page)
							{
							echo "<li><a href='pending-users.php?page=".$j."'> ".$j."</a></li>";
							}
							else
							{
							echo "<li class='active'><a href='pending-users.php?page=".$j."'> ".$j."</a></li>";
							}
							}
						?>
                        </ul>
