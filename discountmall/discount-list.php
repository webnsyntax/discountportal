  ...
  else
  {
    ...
    else
    {
      ...
      move_uploaded_file($dimage_tmp_name4, $new_path4);
		...
		$udiscount=mysql_query("update discounts set category='$category', adtitle='$adtitle', discount='$discount', address='$address', cdetails='$cdetails', description='$description', dlogo='$new_path1', udate=curdate(), city='$city', description2='$description2', description3='$description3', expdate='$expdate', ddetails='$ddetails' where disid='{$discountid}'");
		if($udiscount)
		{
	...
	{
				//echo "hi";
		$udiscount=mysql_query("update discounts set category='$category', adtitle='$adtitle', discount='$discount', address='$address', cdetails='$cdetails', description='$description', udate=curdate(), city='$city', description2='$description2', description3='$description3', expdate='$expdate', ddetails='$ddetails' where disid='{$discountid}'");
		if($udiscount)
		{
			...
			<div class="row">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <option value="Education" <?php if($edetails['category']=="Education"){ ?> selected="selected" <?php } ?>>Education</option>
                    ...
                    <option value="SuperMarkets" <?php if($edetails['category']=="SuperMarkets"){ ?> selected="selected" <?php } ?>>Super Markets</option>
                    ...
                    <option value="Services" <?php if($edetails['category']=="Services"){ ?> selected="selected" <?php } ?>>Other Services</option>
                                    </select>
                                  </div>
                            </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-10">
                                    <textarea class="form-control" rows="3" name="ddetails" id="ddetails" placeholder="Discount Details"><?php echo $edetails['ddetails']; ?></textarea>
                                  </div>
                                </div>
                  ...
                  <div class="pull-left">Discounts List</div>
                   <div class="widget-icons pull-right">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a href="discount-list.php?category=Education">Education</a></li>
                        ...
                        <li><a href="discount-list.php?category=SuperMarkets">Super Markets</a></li>
                        ...
                        <li><a href="discount-list.php?category=Services">Other Services</a></li>
                      </ul>
                    </div>
                  </div>
                  <div class="clearfix"></div>
