...
if(isset($_POST['sub']) && $_POST['sub']=="Add")
{
	...
	else if(pathinfo($acard_name,PATHINFO_EXTENSION) != "jpg" && pathinfo($acard_name,PATHINFO_EXTENSION) != "png" && pathinfo($acard_name,PATHINFO_EXTENSION) != "jpeg" && pathinfo($acard_name,PATHINFO_EXTENSION) != "JPEG" && pathinfo($acard_name,PATHINFO_EXTENSION) != "PNG" && pathinfo($acard_name,PATHINFO_EXTENSION) != "JPG")
	{
		echo '<script> alert("Error:Aadhar Card Should be In jpg or png or jpeg Formats Only")</script>';
		header('Refresh:0.0005; url=new-user.php');
	}
	else if(pathinfo($user_name,PATHINFO_EXTENSION) != "jpg" && pathinfo($user_name,PATHINFO_EXTENSION) != "png" && pathinfo($user_name,PATHINFO_EXTENSION) != "jpeg" && pathinfo($user_name,PATHINFO_EXTENSION) != "JPEG" && pathinfo($user_name,PATHINFO_EXTENSION) != "PNG" && pathinfo($user_name,PATHINFO_EXTENSION) != "JPG")
	{
		...
		else
		{
			...
			if($insert_user)
			{
				...
				if($update_user)
				{
					...
					$card_insert=mysql_query("insert into discards (userid, card_type, card_amount, issue_date, valid_date, apply_date) values ('$userid', '$card_type', '$amount', '$todate', '$expireDate', curdate())");
					if($card_insert)
					{
						$cid=mysql_insert_id();
						if($cid > '9999')
						...
						$cardid="DKM".$city.$cadd.$cid;
						$card_update=mysql_query("update discards set cardid='$cardid' where sno='{$cid}'");
						if($card_update)
						{
...
{
	document.getElementById('emobile').innerHTML="<img src='img/loading.gif' width=70 height=50>";
	var cmobile=document.getElementById('mobile').value;
	var queryString = "?umobile=" + cmobile;
	...
	obj.open("GET", "check-data.php" + queryString, true);
	obj.send();
	...
	{
	document.getElementById('emobile').innerHTML=obj.responseText;
	}
	}
}
function checkemail()
{
	document.getElementById('eemail').innerHTML="<img src='img/loading.gif' width=70 height=50>";
	var cemail=document.getElementById('email').value;
	var queryString = "?uemail=" + cemail;
	if(window.Activexobject)
	{
	obj=new Activexobject("Microsoft.XMLHTTP");
	}
	...
	if(obj.readyState == 4 && obj.status == 200)
	{
	document.getElementById('eemail').innerHTML=obj.responseText;
	}
	}
}
function checkaadhar()
{
	document.getElementById('eaadhar').innerHTML="<img src='img/loading.gif' width=70 height=50>";
	var caadhar=document.getElementById('aid').value;
	var queryString = "?uaadhar=" + caadhar;
	if(window.Activexobject)
	{
	obj=new Activexobject("Microsoft.XMLHTTP");
	}
	...
	if(obj.readyState == 4 && obj.status == 200)
	{
	document.getElementById('eaadhar').innerHTML=obj.responseText;
	}
	}
}
</script>
...
<div class="content">
    ...
    <div class="sidebar">
		...
		<li class="has_sub"><a href="#" class="open"><i class="fa fa-list-alt"></i> <span>Users</span> <span class="pull-right"><i class="fa fa-chevron-left"></i></span></a>
            <ul>
				<li><a href="new-user.php" class="active">New User</a></li>
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
        ...
        <div class="bread-crumb">
          ...
          <a href="#" class="bread-current">Adding User</a>
        </div>
                    ...
                    <!-- Profile form -->
                                    ...
                                    <div class="form profile">
                                      ...
                                      <form class="form-horizontal" method="post" enctype="multipart/form-data" action="" onsubmit="return valid_details();" autocomplete="off">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                              <input type="text" class="form-control" id="email" name="email" placeholder="Customer Email Id" onchange="return checkemail();">
                                            	<span id="eemail"></span>
                                            </div>
                                          </div>
                                          <!-- Telephone -->
                                          <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                              <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Customer Mobile Number" onchange="return checkmobile();">
										...
										<div class="form-group">
										  ...
										  <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                              <input type="text" class="form-control" id="aid" name="aid" placeholder="Aadhar Card Number" onchange="return checkaadhar();">
									...
									<h4>Card Details</h4>
                                            ...
                                            <div class="col-lg-6">                               
												...
												<option value="family4">Family(4) Card</option>
												<option value="family5">Family(5) Card</option>
												<option value="family6">Family(6) Card</option>
